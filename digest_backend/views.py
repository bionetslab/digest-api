...
def set(request) -> Response:
    ...
    result = cache.get('executor').run_set(data)
...
def cluster(request) -> Response:
    ...
    result = cache.get('executor').run_cluster(data)
    return Response(result)
...
def set_set(request) -> Response:
    ...
    result = cache.get('executor').run_set_set(data)
    return Response(result)
...
def id_set(request) -> Response:
    ...
    result = cache.get('executor').run_id_set(data)
    return Response(result)
